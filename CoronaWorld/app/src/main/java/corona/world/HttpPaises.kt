...
object HttpPaises{
    val urlPaises = "https://covid19-brazil-api.now.sh/api/report/v1/countries"
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    fun readCountrys(json: JSONArray) : List<Paises>?{
        val paises = arrayListOf<Paises>()
        try {
